...
class ResourceProvider {
    ...
    refresh(language) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger.debug('[ResourceProvider]: refreshing language', language, 'with', namespaces);
...
export { FormattedMessage$1 as FormattedMessage, IntlProvider$1 as IntlProvider, IntlBackendProvider, IntlNamespaceProvider, IntlNamespaces, logger, configureLogger, Level, defineMessages, ResourceProvider };
