...
(function (InltNamespaces) {
    ...
    })(MessageConverter = InltNamespaces.MessageConverter || (InltNamespaces.MessageConverter = {}));
    function getResourceKey(messageDescriptor, namespace, params) {
        const metadata = InltNamespaces.getMessageMetadata(messageDescriptor, namespace);
        return `[${metadata.namespace}${namespaceSeparator}${metadata.key} (${params})]`;
    }
    InltNamespaces.getResourceKey = getResourceKey;
    ...
    InltNamespaces.getMessageMetadata = getMessageMetadata;
    ...
    InltNamespaces.removeNamespaceFromResource = removeNamespaceFromResource;
    ...
    InltNamespaces.parseId = parseId;
    ...
    InltNamespaces.addNamespaceToResource = addNamespaceToResource;
})(exports.InltNamespaces || (exports.InltNamespaces = {}));
...
exports.FormattedMessage = class FormattedMessage extends ReactIntl.FormattedMessage {
    ...
    render() {
        ...
        if (this.context.intlNamespace.includeMetadata) {
            ...
            const metadata = exports.InltNamespaces.getMessageMetadata(this.props, currentNamespace);
    ...
    getChildContext() {
        ...
        const formatMessage = (messageDescriptor, values) => {
            ...
            if (this.context.intlNamespace.showIds) {
                return exports.InltNamespaces.getResourceKey(messageDescriptor, getNameOfCurrentNamespace(), Object.getOwnPropertyNames(values));
            }
            else {
...
exports.IntlNamespaceProvider = class IntlNamespaceProvider extends React.Component {
    ...
    getChildContext() {
        ...
        return {
            intlNamespace: {
                ...
                loggingEnabled,
                missingMessage: messageDescriptor => {
                    const missingMessage = exports.InltNamespaces.getMessageMetadata(messageDescriptor, namespace);
    ...
    namespaceLoadedNotification({ namespace: messagesNamespace, resource: messages, }) {
        ...
        if (includeNamespace.includes(messagesNamespace)) {
            messages = exports.InltNamespaces.addNamespaceToResource(messages, messagesNamespace);
            const newState = {
                messages: Object.assign({}, this.state.messages, messages),
            };
            this.setState(newState);
