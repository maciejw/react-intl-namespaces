...
})(exports.IntlNamespaces || (exports.IntlNamespaces = {}));

exports.FormattedMessage = class FormattedMessage extends ReactIntl.FormattedMessage {
    constructor(props, context) {
        invariant(context.intlNamespace !== undefined, 'Missing intlNamespace context. Use IntlNamespaceProvider inside IntlBackendProvider');
        super(props, context);
    }
    render() {
        ...
        if (this.context.intlNamespace.includeMetadata) {
            ...
            const metadata = exports.IntlNamespaces.getMessageMetadata(this.props, currentNamespace);
...
exports.FormattedMessage = __decorate([
    IntlNamespaceContext.Provide
], exports.FormattedMessage);

exports.IntlProvider = class IntlProvider extends ReactIntl.IntlProvider {
    constructor(props, context) {
        super(props, context);
    }
    getChildContext() {
        ...
        invariant(this.context.intlNamespace !== undefined, 'Missing intlNamespace context. Use IntlNamespaceProvider inside IntlBackendProvider');
        ...
        const formatMessage = (messageDescriptor, values) => {
            ...
            if (showIds) {
                return exports.IntlNamespaces.getResourceKey(messageDescriptor, getNameOfCurrentNamespace(), Object.getOwnPropertyNames(values || {}));
            }
            else {
...
exports.IntlProvider = __decorate([
    IntlNamespaceContext.Provide
...
class ConsoleLogger {
    ...
    error(message, ...params) {
        if ((this.logLevel & exports.Level.error) === exports.Level.error) {
            currentConsole.error(message, ...params);
        }
    }
    info(message, ...params) {
        if ((this.logLevel & exports.Level.info) === exports.Level.info) {
            currentConsole.info(message, ...params);
        }
    }
    debug(message, ...params) {
        if ((this.logLevel & exports.Level.debug) === exports.Level.debug) {
...
function configureLogger(level) {
    exports.logger = new ConsoleLogger(level);
}

exports.IntlBackendProvider = class IntlBackendProvider extends React.Component {
    constructor(props, context) {
        super(props, context);
    }
    render() {
    ...
    getChildContext() {
        const defaultGetMessagesFromNamespaceFactory = l => (n, ins) => __awaiter(this, void 0, void 0, function* () {
            exports.logger.debug('[IntlBackendProvider]: getting messages for', n, ins);
            return {};
        });
        const defaultAddMissingMessageFactory = l => m => {
            exports.logger.debug('[IntlBackendProvider]: missing message', m);
        };
...
exports.IntlBackendProvider = __decorate([
    IntlBackendContext.Define
], exports.IntlBackendProvider);

exports.IntlNamespaceProvider = class IntlNamespaceProvider extends React.Component {
    constructor(props, context) {
        super(props, context);
        this.state = { messages: {} };
    }
    componentWillMount() {
        ...
        invariant(this.context.intlBackend !== undefined, 'Missing intlBackend context. Use IntlNamespaceProvider inside IntlBackendProvider');
    ...
    getChildContext() {
        ...
        return {
            intlNamespace: {
                ...
                loggingEnabled,
                missingMessage: messageDescriptor => {
                    const missingMessage = exports.IntlNamespaces.getMessageMetadata(messageDescriptor, namespace);
    ...
    render() {
        ...
        return (React.createElement(exports.IntlProvider, Object.assign({}, props, { messages: this.state.messages }), this.props.children));
    }
    namespaceLoadedNotification({ namespace: messagesNamespace, resource: messages, }) {
        ...
        if (includeNamespace.includes(messagesNamespace)) {
            messages = exports.IntlNamespaces.addNamespaceToResource(messages, messagesNamespace);
            const newState = {
                messages: Object.assign({}, this.state.messages, messages),
            };
            this.setState(newState);
...
exports.IntlNamespaceProvider = __decorate([
    IntlNamespaceContext.Define,
    IntlBackendContext.Provide
], exports.IntlNamespaceProvider);
...
class ResourceProvider {
    constructor(server, getDownloadDelay = () => 100, getCurrentTime = () => new Date()) {
    ...
    refresh(language) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            exports.logger.debug('[ResourceProvider]: refreshing language', language, 'with', namespaces);
    ...
    ...namespaces) {
        ...
        for (const namespace of namespaces) {
            exports.logger.debug('[ResourceProvider]: requesting namespace', namespace);
        ...
        if (scheduleDownload) {
            exports.logger.debug('[ResourceProvider]: rescheduling download');
            this.cancelDownload();
    ...
    requestMessage(message) {
        ...
        exports.logger.debug('[ResourceProvider]: requesting message', message);
    ...
    changeLanguage(language) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            exports.logger.debug('[ResourceProvider]: changing language to', language);
