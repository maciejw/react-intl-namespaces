...
class IframeWindow extends React.Component {
    render() {
        ...
        return (React.createElement("div", { className: container, style: container$$1, "data-ignore-locize-editor": "true" },
            React.createElement("iframe", { className: iframe, ref: e => this.iframeRef(e), style: iframe$$1, src: this.props.url })));
    }
    iframeRef(e) {
...
class FullWindow extends React.Component {
    componentDidMount() {
...
class EditorWindow$1 extends React.Component {
    render() {
        switch (this.props.mode) {
            case 'iframe':
                return React.createElement(IframeWindow, Object.assign({}, this.props));
            case 'window':
                return React.createElement(FullWindow, Object.assign({}, this.props));
        }
    }
}
...
class EditorComponent extends React.Component {
    ...
    render() {
        ...
        return ReactDOM.createPortal(React.createElement("div", { "data-ignore-locize-editor": "true" },
            ...
            React.createElement(EditorWindow$1, { mode: this.props.mode, editorWidthInPixels: this.props.editorWidthInPixels, windowOpenTimeout: 3000, window: window, url: this.props.url, onOpen: i => this.open(i) })), this.editor);
    }
    onShowIds() {
