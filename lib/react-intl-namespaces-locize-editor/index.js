...
class EditorPanel$1 extends React.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: cn(panel, {
                [pinned]: this.state.pinned,
            }) },
            React.createElement("span", { className: cn(content) },
                React.createElement("div", { className: title }, "locize editor"),
                languages.length > 0 && (React.createElement("select", { className: select, value: this.props.language, onChange: e => this.props.onChangeLanguage(e.target.value) }, languages.map(l => (React.createElement("option", { key: l, value: l, className: option }, l))))),
                ' ',
                React.createElement("button", { onClick: () => this.props.onSearchEnabled(), className: cn(button, {
                        [buttonOn]: this.props.searchEnabled,
                        [buttonOff]: !this.props.searchEnabled,
                    }) }, this.props.searchEnabled ? 'On' : 'Off'),
                ' ',
                React.createElement("button", { onClick: () => this.props.onShowIds(), className: cn(button, {
                        [buttonOn]: this.props.showIds,
                        [buttonOff]: !this.props.showIds,
                    }) }, "id's"),
                ' ',
                React.createElement("button", { onClick: () => this.props.onRefresh(), className: cn(button, buttonOn) }, "refresh"),
                ' '),
            React.createElement("button", { className: cn(button, pin, buttonOn, {
                    [pinned]: this.state.pinned,
...
class EditorWindow$1 extends React.Component {
    ...
    componentDidMount() {
        if (this.props.mode === 'window') {
            const openedWindow = window.open(this.props.url, 'locize-editor', '', true);
            if (openedWindow !== null) {
                this.props.onOpen(new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                    yield delay(3000);
    ...
    render() {
        switch (this.props.mode) {
            case 'iframe':
                const { container: container$$1, iframe: iframe$$1 } = EditorWindow$1.inlineStyles(this.props.editorWidthInPixels);
                return (React.createElement("div", { className: container, style: container$$1, "data-ignore-locize-editor": "true" },
                    React.createElement("iframe", { className: iframe, ref: e => {
                            if (e !== null) {
                                this.props.onOpen(new Promise(resolve => {
...
(function (EditorWindow$$1) {
    EditorWindow$$1.inlineStyles = editorWidthInPixels => ({
        container: {
...
})(EditorWindow$1 || (EditorWindow$1 = {}));

class exports.Editor extends React.Component {
    render() {
        return React.createElement(EditorComponent, Object.assign({}, exports.Editor.defaultProps, this.props));
    }
}
class EditorComponent extends React.Component {
    ...
    render() {
        ...
        return ReactDOM.createPortal(React.createElement("div", { "data-ignore-locize-editor": "true" },
            React.createElement(EditorPanel$1, { showIds: showIds, searchEnabled: searchEnabled, onRefresh: () => this.onRefresh(), onSearchEnabled: () => this.onSearchEnabled(), onShowIds: () => this.onShowIds(), language: this.props.language, onChangeLanguage: this.props.onChangeLanguage, getLanguages: this.props.getLanguages }),
            React.createElement(EditorWindow$1, { mode: this.props.mode, editorWidthInPixels: this.props.editorWidthInPixels, url: this.props.url, onOpen: i => this.open(i) })), this.editor);
    }
    onShowIds() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (e.srcElement) {
                ...
                if (ns && key) {
                    ...
                    const window = yield this.openedWindow;
                    if (!window.closed) {
