...
class EditorWindow extends Component {
    ...
    render() {
        return (createElement("div", { style: EditorWindow.styles.container, "data-ignorelocizeeditor": "", "data-translated": "" },
            createElement("iframe", { ref: e => this.props.onOpen(e), style: EditorWindow.styles.iframe, "data-ignorelocizeeditor": "", "data-translated": "", src: this.props.url })));
    }
}
...
class EditorPanel extends Component {
    ...
    render() {
        return (createElement("div", { "data-ignorelocizeeditor": "", "data-translated": "", style: EditorPanel.styles.panel },
            createElement("h4", { id: "locize-title", "data-ignorelocizeeditor": "", style: {
                    color: '#1976d2',
            ...
            createElement("button", { onClick: () => this.props.clicked(), style: Object.assign({}, EditorPanel.styles.button, (this.props.enabled
...
class Editor extends Component {
    ...
    render() {
        ...
        return createPortal([
            createElement(EditorPanel, { key: "1", enabled: enabled, clicked: () => this.toggle() }),
            createElement(EditorWindow, { key: "2", url: this.props.url, onOpen: i => this.open(i) }),
        ], this.editor);
    }
    get safeProps() {
        const _a = this.props, { children } = _a, rest = __rest(_a, ["children"]);
        return Object.assign({}, Editor.defaultProps, rest);
    }
    open(window) {
        if (window) {
