        ...
        switch (this.props.mode) {
            case 'iframe':
                ...
                return (createElement("div", { className: container, style: container$$1, "data-ignore-locize-editor": "true" },
                    createElement("iframe", { className: iframe, ref: e => {
                            if (e !== null) {
...
class EditorComponent extends Component {
    ...
    render() {
        ...
        return createPortal(createElement("div", { "data-ignore-locize-editor": "true" },
            ...
            createElement(EditorWindow$1, { mode: this.props.mode, editorWidthInPixels: this.props.editorWidthInPixels, url: this.props.url, onOpen: i => this.open(i) })), this.editor);
    }
    onShowIds() {
