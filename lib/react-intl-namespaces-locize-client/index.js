...
var reactIntlNamespaces = require('react-intl-namespaces');
...
class exports.LocizeClient {
    constructor(globalFetch, options) {
        this.globalFetch = this.configureFetch(globalFetch);
        this.options = Object.assign({}, exports.LocizeClient.getDefaults(), options);
    }
    pullNamespace(ns, language, params) {
        return __awaiter(this, void 0, void 0, function* () {
            const query = exports.LocizeClient.PullQueryParams.serialize(exports.LocizeClient.PullQueryParams.parse(params));
            ...
            const resource = reactIntlNamespaces.IntlNamespaces.MessageConverter.flattenTree(result);
            return resource;
        });
    }
    getLanguages() {
...
})(exports.LocizeClient || (exports.LocizeClient = {}));
